 ...
 * @return bool
 */
function isAdminPanel($url = null)
{
	if (empty($url)) {
		$isValid = (
 ...
 * @return string|null
 */
function uploadPostPicture($tmpUploadDir, $file)
{
 ...
 * @return string|null
 */
function uploadPostCustomFieldFile($tmpUploadDir, $file)
{
	if (!$file instanceof \Illuminate\Http\UploadedFile) {
		return null;
	}
 ...
 */
function hashId($in, $toNum = false, $withPrefix = true, $minHashLength = 11, $salt = '')
{
 ...
 * @return false|int
 */
function isHashedId($in, $minHashLength = 11)
{
 ...
 * @return array
 */
function regexSimilarRoutesPrefixes()
{
 ...
 * @return string
 */
function colourBrightness($hexCode, $percent)
{
