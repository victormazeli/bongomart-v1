...
class BackupController extends Controller
{
	...
	public function create()
	{
		try {
			...
			response($e->getMessage(), Response::HTTP_INTERNAL_SERVER_ERROR);
		}
	...
	public function download()
	{
		...
		if ($adapter instanceof Local) {
			...
			if ($disk->exists($filename)) {
				...
				abort(Response::HTTP_NOT_FOUND, trans('admin.backup_doesnt_exist'));
			}
		} else {
			abort(Response::HTTP_NOT_FOUND, trans('admin.only_local_downloads_supported'));
		}
	}
